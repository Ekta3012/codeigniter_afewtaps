                 ...
                 <!-- Table -->
				        <div class="col-lg-12">
							<div class="ibox float-e-margins">
								...
								<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">View Coupons</div>
												 ...
												 foreach ($coupon as $cdata)
												   {
														...
														echo '<tr class="">
																...
																<td>'.$cdata->off.' %</td>
																<td>'.$cdata->min_amt.'</td>
																<td class="text-center">'.date('D, j M\' y', $cdata->valid_till).'</td>
						...
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								 ...
								 <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">View One + One Offer</div>
										...
										<table class="table table-striped table-bordered table-hover dataTables-example" >
											...
											<?php
											 if (count($offer) > 0)
											   {
												 $i = 0 ;
												 foreach ($offer as $cdata)
												   {
													    $i++;
														$status = ($cdata->ostatus == 1) ? 'Active' : 'Inactive';
														echo '<tr class="">
																<td>'.$i.'</td>
																<td>'.$cdata->{'cname'}.'</td>
																<td class="text-center">'.date('D, j M\' y', $cdata->valid_till).'</td>
																<td class="text-center">'.$status.'</td>
																<td class="text-center"><a href="'.base_url().'index.php/coupon/editOffer/'.$cdata->{'id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/coupon/offerdel/'.$cdata->{'id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></td>
															</tr>';
												   }
											   }
											   else

												 ...
												 foreach ($category as $cdata)
												   {
														...
														echo '<tr class="">
																...
																<td class="text-left"><a href="'.base_url().'index.php/category/index/'.$cdata->{'id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/category/del/'.$cdata->{'id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></td>
															</tr>';
												   }
											   }
											   else

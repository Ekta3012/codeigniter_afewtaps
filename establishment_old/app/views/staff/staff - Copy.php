                        ...
                        <div class="ibox-content">
							...
							<?php echo form_open_multipart('', array('class' => 'form-horizontal' , 'novalidate' => 'novalidate')); ?>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Employee Id</label>
                                    <div class="col-sm-10"><input type="text" name="employee_id" value="<?php echo isset($info->{'employee_id'}) ? $info->{'employee_id'} : set_value('employee_id'); ?>" placeholder="Employee Id" class="form-control" autocomplete="off" /></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Image</label>
									...
									<span style="font-size:11px;text-align:center;padding-left:155px"><i><strong>Note :</strong></i> Please upload a clear picture for the customers to easily locate the Service Staff.</span>
                                </div>

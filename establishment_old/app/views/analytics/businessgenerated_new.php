                                            ...
                                            <div class="box-body no-padding">
                                                <table class="table table-condensed">
                                                    <tbody>
                                                        ...
                                                        <?php if(isset($total_monthly_generated_business)){
                                                            $cntr = 1;
                                                            foreach ($total_monthly_generated_business as $tmgb){
                                                            ?>
                                                            <th><?php echo $tmgb['month_name'].'-'.$tmgb['year']."<br>".$tmgb['amount'];?></th>
                                                ...
                                                <table class="table table-condensed">
                                                    <tbody>
                                                        <tr>
                                                            <th>Staff Orders</th>
                                                        <?php if(isset($staff_monthly_generated_business_2)){
                                                            $cntr = 1;
                                                            foreach ($staff_monthly_generated_business_2 as $tmgb){
                                                            ?>
                                                ...
                                                <table class="table table-condensed">
                                                    <tbody>
                                                        ...
                                                        <?php if(isset($customer_monthly_generated_business_2)){
                                                            $cntr = 1;
                                                            foreach ($customer_monthly_generated_business_2 as $tmgb){
                                                            ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="box box-solid bg-teal-gradient">
                                            ...
                                            if (isset($staff_monthly_generated_business)) {
                                                ...
                                                ?>
                                                <div class="box-header">
                                                    <h3 class="box-title">Business Generated By Staff</h3>
                                                </div>
                                                <div id="chart"> 
                                                    <ul id="numbers">
                                                        <?php for ($j = 5; $j >= 1; $j--) { ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="box">
                                            ...
                                            if (isset($customer_monthly_generated_business)) {
                                                ...
                                                ?>
                                                <div class="box-header">
                                                    <h3 class="box-title">Business Generated By Customer</h3>
                                                </div>
                                                <div id="chart"> 
                                                    <ul id="numbers">
                                                        <?php for ($j = 5; $j >= 1; $j--) { ?>

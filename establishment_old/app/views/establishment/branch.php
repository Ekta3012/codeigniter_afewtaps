				 ...
				 <div class="row">
				   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
						<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Add More Branch</div>
                        <div class="ibox-content">
							...
							<?php echo form_open('', array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group"><label class="col-sm-4 control-label">Secondary Contact Name</label>
                                    <div class="col-sm-6"><input type="text" name="secondary_contact_name" class="form-control" placeholder="Secondary Contact Name"></div>
                                </div>
...
$('input:radio[id="FranchiseeRadio"]').change(function(){
	
    alert('Message..');
	
	$("#SelfOwned").prop('checked', true);

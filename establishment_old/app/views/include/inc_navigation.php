...
<!-- <a class="<?php echo isset($analytics_active) ? "active" : ""; ?>" href="<?php echo site_url(); ?>/analytics/staffAnalytics"><i class="fa fa-dashboard"></i> <span class="nav-label">Analytics</span></a> -->
                ...
                <ul class="nav nav-second-level collapse">
                    <li class="<?php echo isset($order_active) ? "active" : ""; ?>"><a href="<?php echo site_url(); ?>/analytics/orders">No Of Orders</a></li>

                    <li class="<?php echo isset($business_active) ? "active" : ""; ?>"><a href="<?php echo site_url(); ?>/analytics/businessGeneratedn">Business Generated</a></li>

...
//        echo $this->db->last_query();die();
    ...
    public function getOrderHistoryDetails_staff($establid = '') {
        $stime = mktime(0, 0, 0, date('m'), date('d'), date('Y'));
        $etime = mktime(23, 59, 59, date('m'), date('d'), date('Y'));
        ...
        $query = $this->db->get_where($this->_order, array('establishment_id' => $establid, 'order_time >=' => $stime, 'order_time <=' => $etime,'added_by'=>'2'));
        $order = array();
    ...
    public function getOrderHistoryDetails_customer($establid = '') {
        $stime = mktime(0, 0, 0, date('m'), date('d'), date('Y'));
        $etime = mktime(23, 59, 59, date('m'), date('d'), date('Y'));
        ...
        $query = $this->db->get_where($this->_order, array('establishment_id' => $establid, 'order_time >=' => $stime, 'order_time <=' => $etime,'added_by'=>'1'));
//        echo $this->db->last_query();die();
        $order = array();

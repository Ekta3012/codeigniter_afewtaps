            ...
            <ul class="nav metismenu" id="side-menu">
				...
				<li class="<?php echo isset($analytics_active) ? "active" : "" ; ?>">
                   <!-- <a class="<?php echo isset($analytics_active) ? "active" : "" ; ?>" href="<?php echo site_url(); ?>/analytics/staffAnalytics"><i class="fa fa-dashboard"></i> <span class="nav-label">Analytics</span></a> -->
					 ...
					 <a href="#" class="<?php echo isset($analytics_active) ? "active" : "" ; ?>"><i class="fa fa-dashboard"></i> <span class="nav-label">Analytics</span><span class="fa arrow"></span></a>
				...
				<li class="<?php echo isset($real_time_active) ? "active" : "" ; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                       ...
                       <!-- <li class="<?php echo isset($order_active) ? "active" : "" ; ?>"><a href="<?php echo site_url(); ?>/menu/index">Menu</a></li> -->
				        ...
				        <li class="<?php echo isset($location_activedd) ? "active" : "" ; ?>"><a href="#"><i class="fa fa-clock-o"></i> <span class="nav-label">Last Order Notification</span></a></li>
				...
				<li class="<?php echo isset($merchant_activess) ? "active" : "" ; ?>">
                    <a href="#"><i class="fa fa-info-circle"></i> <span class="nav-label">Miscellaneous</span></a>
                </li>

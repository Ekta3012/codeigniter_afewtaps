							...
							<div class="ibox float-e-margins">
								<div class="ibox-content">
									<ul style="margin:0;padding:0">
									  <li><input type="radio" name="method" value="1" id="radio1" />&nbsp;Yes<br /><p>Notifications shall be pushed for orders placed
									  ...
									  <li><input type="radio" name="method" value="1" id="radio1" />&nbsp;No</li>
									</ul><br />

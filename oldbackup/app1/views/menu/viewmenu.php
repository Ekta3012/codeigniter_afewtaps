												...
												{   
													...
													echo '<div class="row" style="margin:5px;">
															<div class="row">
															  ...
															  <div class="col-md-2"><a href="'.base_url().'index.php/menu/index/'.$item_result->{'menu_id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/menu/del/'.$item_result->{'menu_id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></div>
															</div>

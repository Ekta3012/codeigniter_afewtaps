...
.orderBx{border:1px solid #888;border-radius:5px;padding:10px;margin-bottom:4px !important}
...
.detailIconB{background:url('../../assets/img/arrowb.png');background-repeat:no-repeat;float:left;background-position:center center}
								...
								<div class="ibox-content">
									...
									<div class="tabs-container">
										<ul class="nav nav-tabs">
											<li class="active" style="padding:0 25px"><a href="#tab-1" data-toggle="tab" aria-expanded="false">All</a></li>
											<li class="" style="padding:0 25px"><a href="#tab-2" data-toggle="tab" aria-expanded="true">New</a></li>
											<li class="" style="padding:0 25px"><a href="#tab-2" data-toggle="tab" aria-expanded="true">Pending</a></li>
											<li class="" style="padding:0 25px"><a href="#tab-2" data-toggle="tab" aria-expanded="true">Cancelled</a></li>
										</ul>
												...
												<div class="panel-body">
													...
													<div class="row" style="margin:10px 0 40px 0">
														<div class="col-lg-6">
															...
															<div class="pull-left wdth100"><span class="detailIconB wdth100 text-center">&nbsp;</span></div>
														...
														<div class="col-lg-6">
																...
																<a href="#">
																	 <div class="col-sm-12">
																		...
																		<div class="pull-left wdth100 pdbtm">
																		   ...
																		   <div class="pull-right text-right lnehght24">Cash on delivery<br /><i class="fa fa-clock-o"></i> <span class="">14:08</span></div>
																		</div>
															...
															<div class="pull-left wdth100"><span class="detailIconR wdth100 text-center">&nbsp;</span></div>
										        ...
										        <div class="row">
													  ...
													  <div class="col-lg-9">
														 <div class="row" style="overflow:hidden;overflow-x:scroll">
															  <!-- Slider -->
															  <div class="floorContainer" style="width:1325px;height:320px;margin-top:8px">
																 <div class="flrbox" style="">
																	<div class="text-center mrgn15"><img src="<?php echo base_url(); ?>assets/img/user_icon.png" /></div>
																	<div class="text-center mrgn15 fntsze10" style=""><img src="<?php echo base_url(); ?>assets/img/online.png" /> Online</div>
																	<div class="text-center mrgn25 clr666" style="font-size:18px">Mr Suresh</div>
																 ...
																 <div class="flrbox">
																	<div class="text-center mrgn15"><img src="<?php echo base_url(); ?>assets/img/user_icon.png" /></div>
																	<div class="text-center mrgn15 fntsze10 offline" style=""><img src="<?php echo base_url(); ?>assets/img/offline.png" /> Offline</div>
																	<div class="text-center mrgn25 clr666" style="font-size:18px">Mr Rajesh</div>
																	<div class="text-center mrgn25" style="font-size:18px">
																		 <div class="fntsze13" style="background:#EDEDED;border:1px solid #888;">12</div>
																		 <div class="fntsze13" style="background:#f9f9f9;border-left:1px solid #888;border-right:1px solid #888;">12:15</div>
																		 <div class="fntsze13" style="background:#EDEDED;border:1px solid #888;"><i class="fa fa-inr"></i> 9,566</div>

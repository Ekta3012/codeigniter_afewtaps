										   ...
										   foreach ($establishment as $data)
											   {
												   ...
												   echo '<tr class="">
															...
															<td>'.$data->{'address'}.'</td>
															<td>'.$data->{'email'}.'</td>
															<td class="text-center"><a title="Edit" href="'.base_url().'index.php/establishment/estabedit/'.$data->{'user_id'}.'"><img src="'.config_item('base_url').'assets/img/edit.png"></a>&nbsp;&nbsp;<a title="Delete" id="'.$data->{'user_id'}.'" href="'.base_url().'index.php/establishment/delestab/'.$data->{'user_id'}.'" onclick="return confirm(\'Are you sure! You want to delete this entries?\')"><img src="'.config_item('base_url').'assets/img/delete.png"></a>

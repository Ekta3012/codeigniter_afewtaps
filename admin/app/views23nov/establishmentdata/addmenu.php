					  ...
					  <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Add Menu Items</div>
                        ...
                        <?php
								 ...
								 <div class="row text-center">
									<!--  <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/1"><button class="btn btn-w-m <?php echo isset($orderhistory) ? $orderhistory : "nonactive" ; ?>" data-attr="1" type="button">Order History</button></a>
									  <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/2"><button class="btn btn-w-m <?php echo isset($insideinformation) ? $insideinformation : "nonactive" ; ?>" data-attr="2" type="button">Inside Information</button></a>
									  <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/3"><button class="btn btn-w-m <?php echo isset($analytics) ? $analytics : "nonactive" ; ?>" data-attr="3" type="button">Analytics</button></a>
                                       <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/4"><button class="btn btn-w-m <?php echo isset($ratings) ? $ratings : "nonactive" ; ?>" data-attr="4" type="button">Ratings</button></a>
                                          <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/5"><button class="btn btn-w-m <?php echo isset($staff) ? $staff : "nonactive" ; ?>" data-attr="5" type="button">Staff</button></a>-->
                                             <a href="<?php echo base_url(); ?>index.php/establishmentdata/menu/1"><button class="btn btn-w-m <?php echo isset($menuitem) ? $menuitem : "nonactive" ; ?>" data-attr="6" type="button">Menu Items</button></a>
                                               <!-- <a href="<?php echo base_url(); ?>index.php/establishmentdata/view/7"><button class="btn btn-w-m <?php echo isset($location) ? $location : "nonactive" ; ?>" data-attr="7" type="button">Location</button></a>-->
							...
							<?php echo form_open('', array('class' => 'form-horizontal')); ?>
								...
								<!--<div class="form-group"><label class="col-sm-2 control-label">Cuisine</label></a>
                                    <div class="col-sm-10">
									   
									   
									   <select tabindex="-1" style="width: 350px; display: none;" multiple="" class="chosen-select form-control" data-placeholder="Choose a Cuisine..." name="cuisine[]">
										 <?php
										  if (count($cuisine) > 0)
											  {
										...
										<a href="<?php echo site_url(); ?>/cuisine/index?return_url=<?php echo urlencode(current_url()); ?>" title="Add New Cuisine" style="font-size:11px">Add New Cuisine</a>
								...
								<div class="form-group"><label class="col-sm-2 control-label">&nbsp;</label>
									 <div class="col-sm-10">
										<div class="radio radio-success radio-inline">
												<input type="radio" name="cat" value="1" id="radio9" checked="checked" />
												<label for="radio9">Food</label>
										</div>
										
										<div class="radio radio-success radio-inline">
												<input type="radio" value="2" id="radio10" name="cat" <?php echo isset($info->{'type'}) ? ($info->{'type'} == 2 ? "checked='checked'" : "") : ""; ?> />
												<label for="radio10">Drinks</label>
										</div>
										
										<div class="radio radio-success radio-inline">
												<input type="radio" value="3" id="radio11" name="cat" <?php echo isset($info->{'type'}) ? ($info->{'type'} == 2 ? "checked='checked'" : "") : ""; ?> />
												<label for="radio11">Dessert</label>
										</div>

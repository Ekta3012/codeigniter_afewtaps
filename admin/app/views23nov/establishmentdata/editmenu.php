							...
							<?php echo form_open('', array('class' => 'form-horizontal')); ?>
										    ...
										    if (count($branches) > 0)
											  {
										         foreach ($branches as $bdata)
												   {
													  $selected = isset ($info['branch_id']) ? (($info['branch_id'] == $bdata->id) ? "selected='selected'" : "") : "";
								...
								<div class="form-group"><label class="col-sm-2 control-label">&nbsp;</label>
									 <div class="col-sm-10">
										...
										<div class="radio radio-success radio-inline">
												<input type="radio" value="3" id="radio11" name="cat" <?php echo isset ($category_data->main_category) ? (($category_data->main_category == 3) ? "checked='checked'" : "") : ""; ?> />
								...
								<div class="form-group" id="addMoreItem" style="border:1px dashed #888;border-radius:3px;padding:25px"><label class="col-sm-2 control-label">&nbsp;</label>
								 ...
								 //echo $info['items_data']->{'id'};
								    //if(isset($menu['items_data'])?$items_data:"");
								   $i    = 0;

                             ...
                             <?php 
								...
								<?php
									 ...
									 switch ($segment)
									  ...
									  <a href="<?php echo base_url(); ?>index.php/establishmentdata/inside"><button class="btn btn-w-m <?php echo isset($food_active) ? $food_active : "nonactive" ; ?>" data-attr="1" type="button">Service Rating Table</button></a>
                                      ...
                                      <a href="<?php echo base_url(); ?>index.php/establishmentdata/customer"><button class="btn btn-w-m <?php echo isset($customer) ? $customer : "nonactive" ; ?>" data-attr="customer" type="button">New & Returning Customers</button></a>

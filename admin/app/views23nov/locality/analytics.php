									...
									?>
									      <div class="row">
										   <div class="col-sm-6 text-center" style="font-size:15px">
											  <a href="<?php echo base_url().'index.php/locality/analytics/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/1'; ?>" name="month"  id="<?php echo $prev_month; ?>"><p class="<?php echo $lmactive ; ?>"><?php echo $prev_month; ?> (Last month)</p></a>
										   </div>
										   <div class="col-sm-6 text-center" style="font-size:15px">
												 <a href="<?php echo base_url().'index.php/locality/analytics/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/2'; ?>" name="month" id="<?php echo $current_month; ?>"><p class="<?php echo $nmactive ; ?>"><?php echo $current_month; ?> (This month so far)</p></a>
										   </div>
									      </div>
									 ...
									 <?php	 
										 foreach ($response as $ldata)
										     {
													echo '<div class="form-group"><p><strong>'.$ldata['name'].'</strong></p></div>';
													...
													echo  '<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-6 control-label">Business Generated</label><div class="col-sm-6">'.$ldata['business_generated'].'</div>
																</div>
															</div>';
															
													echo  '<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-6 control-label">Average Amount Spend/Day</label><div class="col-sm-6">'.$ldata['avg_spent_per_day'].'</div>
																</div>
															</div>';
													...
													foreach ($ldata['analytic'] as $sdata)
														{
															 ...
															 echo '<div class="form-group">
																		...
																		<div class="col-sm-8 heght30">
																		   ...
																		   <div class="form-group"><div class="col-sm-12 text-left heght30"><label class="col-sm-6 control-label">Business Generated: </label><div class="col-sm-6">Rs. '.$sdata['order'].'</div></div></div>

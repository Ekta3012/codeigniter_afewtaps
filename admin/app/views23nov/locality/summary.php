										...
										?>					
												<div class="row">
												   <div class="col-sm-6 text-center" style="font-size:15px">
													  <a href="<?php echo base_url().'index.php/locality/summary/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/1'; ?>" name="month"  id="<?php echo $summarydata['prev_month']; ?>"><p class="<?php echo $lmactive ; ?>"><?php echo $summarydata['prev_month']; ?> (Last month)</p></a>
												   </div>
												   <div class="col-sm-6 text-center" style="font-size:15px">
														 <a href="<?php echo base_url().'index.php/locality/summary/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/2'; ?>" name="month" id=""><p class="<?php echo $nmactive ; ?>"><?php echo date('M Y'); ?> (This month so far)</p></a>
												   </div>
												</div>
												
											
												<?php echo form_open('locality/summary/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5)); ?>
												<div class="row">
													<div class="col-md-12">

													  <div class="col-md-3 input-group date" style="float:left;margin-right:10px">
															<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="start_date" class="form-control" placeholder="Start Date" required id="start_date">
													  </div>
													  
													  <div class="col-md-3 input-group date" style="float:left;margin-right:10px">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="end_date" class="form-control" value="" placeholder="End Date" required id="end_date">
													  </div>
												...
												<div class="row">
												    ...
												    <div class="form-group">
															<div class="col-sm-12 text-left heght30">
															   <label class="col-sm-4 control-label">Total No. of Orders</label><div class="col-sm-8"><?php echo $summarydata['total_orders']; ?></div>
															</div>
													</div>
															
													<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-4 control-label">Business Generated</label><div class="col-sm-8">Rs. <?php echo $summarydata['business']; ?></div>
																</div>
													</div>
															
													<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-4 control-label">Average Amount Spend/Day</label><div class="col-sm-8">Rs. <?php echo $summarydata['avg_amount_spend']; ?></div>
																</div>
													</div>
															
													<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-4 control-label">Average User Spend</label><div class="col-sm-8">Rs. <?php echo $summarydata['avg_user_spend']; ?></div>
																</div>
													</div>
												...
												<div class="row">
													...
													<div class="form-group">
															<div class="col-sm-12 text-left heght30">
															   <label class="col-sm-4 control-label">Total New Customers</label><div class="col-sm-8"><?php echo $summarydata['new_customer']; ?></div>
															</div>
													</div>
															
													<div class="form-group">
																<div class="col-sm-12 text-left heght30">
																   <label class="col-sm-4 control-label">Total Returning Customers</label><div class="col-sm-8"><?php echo $summarydata['return_customer']; ?></div>
																</div>
													</div>
												...
												<div class="row">
													<div class="col-sm-12 text-left heght30">
													   <label class="col-sm-4 control-label"></strong>Avg Order Completion Time</strong></label><div class="col-sm-8"><?php echo floor($summarydata['avg_order_completion_time']); ?></div>
													</div>

					...
					<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Privacy</div>
                        ...
                        <div class="ibox-content">
						    ...
						    <?php echo validation_errors();  ?>
                            	<?php echo $this->session->flashdata('Privacy_edit') != '' ? '<div style=\'line-height:28px;margin:5px 0 20px 0\' class=\'btn-primary btn-xs msgsuc\'><i class="fa fa-check"></i> Privacy Policy Updated successfully.</div>' : ''; ?>
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12 text-center heght30">
									   <label class="col-sm-4 control-label">Description</label><div class="col-sm-6">
                                       <textarea class="form-control crsntalwd" name="description" id="description"><?php echo $cdata->{'description'}; ?></textarea></div>
									</div>
								</div>

                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
								    <div class="col-sm-12 text-center heght30">
									   <label class="col-sm-4 control-label">Title</label><div class="col-sm-6"><input class="form-control crsntalwd" type="text"  id="title" name="title" value=""/></div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12 text-center heght30">
									   <label class="col-sm-4 control-label">Description</label><div class="col-sm-6"><input class="form-control crsntalwd" type="text"  name="description" id="description"  value=""/></div>
									</div>
								</div>

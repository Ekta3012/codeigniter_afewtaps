								...
								<div class="form-group">
								    ...
								    <div class="col-sm-12 text-center heght30">
									  ...
									  <?php
										 ...
										 echo "<div class=\"taxContainer\" id=\"checkboxes\">";
										 ...
										 foreach ($cate_arr as $key => $category_arr)
											 {
												...
												echo '<label style="border-bottom:1px solid #888" for="cat_'.$key.'">'.$category_arr.'</label>&nbsp;&nbsp;&nbsp;<input style="margin:10px 10px 0 0" name="apply_for[]" class = "pull-right '.$id.'" type="radio" id="'.$id.'" value="'.$key.'" '.$checked.' />';
											 }
									     echo "</div>";

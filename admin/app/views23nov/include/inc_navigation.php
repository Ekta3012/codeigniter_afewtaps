...
<nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
				...
				<?php
				   if (in_array('User Information', $permission_arr))
				    {
				?>		
						<li class="<?php echo isset($order_history) ? "active" : "" ; ?>">
				...
				<li class="<?php echo $estab_active != '' ? "active" : "" ; ?>">
                    <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">User Information</span><span class="fa arrow"></span></a>
		       ...
		       <?php } ?> 
				...
				<li class="<?php echo isset($settings_active) ? "active" : "" ; ?>">
                    <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">Settings</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
      ...
      <ul class="nav metismenu viewadm" id="side-menu"><li class=""><a href="<?php echo site_url(); ?>/establishment/newadmin"><i class="fa fa-user" aria-hidden="true"></i>
</a> <a href="<?php echo site_url(); ?>/establishment/viewadmin"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
</a></li></ul>  
</nav>

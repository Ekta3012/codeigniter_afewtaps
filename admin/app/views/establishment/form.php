...
<link href="<?php echo config_item('base_url'); ?>assets/css/bootstrap-checkbox.css.css" rel="stylesheet">
</head>
<body>
    ...
    <script src="<?php echo config_item('base_url'); ?>assets/js/plugins/pace/pace.min.js"></script>

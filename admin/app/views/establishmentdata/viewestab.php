							...
							<div class="ibox float-e-margins">	
							  <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Establishment Data</div>
								<div class="ibox-content">
								  ...
								  <a href="<?php echo base_url(); ?>index.php/establishmentdata/addmenu" title="Add Menu Items"><strong>Add Menu Items</strong></a>

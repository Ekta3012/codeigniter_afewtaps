...
<body>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
										<?php 
											...
											if (count($branches) > 0)
											  {
												 echo '<select class="form-control m-b" name="estabid">';
	...
	$("body").on("click", "#seatAddContainer", function() {
	  ...
	  var P = '';
	  P += '<div class="row mrgncgb"><input type="text" placeholder="Enter Seat No" class="pull-left form-control wdt60" name="audi[' + start + '][row_no][' + start + '][seat_no][]"></div>';

      ...
      <div id="page-wrapper" class="gray-bg sidebar-content">
	   ...
	   <?php $this->load->view('include/inc_topnav'); ?>
        ...
        <div class="wrapper wrapper-content" id="leftWrapper" style="padding-right:0">
		   ...
		   <?php echo form_open('establishmentdata/editFlr/'.$this->uri->segment(3).'/'.$this->uri->segment(4)); ?>

            <div class="row">
                 <!-- Table -->
				        <div class="col-lg-12">
							<div class="ibox float-e-margins">								
								<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Update Establishments</div>
								  <div class="ibox-content">
									  <div class="" id="floorContainer" style="display:block">
										<div class="row" style="margin:5px 0">
											<div class="col-lg-3">
												<strong><?php echo $data->floor_id; ?></strong>
											</div>
											
											<div class="col-lg-3">
											   <input type="text" name="rest" value="<?php echo $data->location_name; ?>" class="form-control" placeholder="Add Table No./Location" />
											</div>
											
											<div class="col-lg-4">
											   <select name="form" class="form-control">
												   <option>-- Select Form --</option>
												   <option value="1" <?php echo ($data->form == 1) ? "selected='selected'" : ""; ?>>Standee</option>
												   <option value="2" <?php echo ($data->form == 2) ? "selected='selected'" : ""; ?>>Sticker</option>
												   <option value="3" <?php echo ($data->form == 3) ? "selected='selected'" : ""; ?>>Flag</option>
												</select>
											</div>

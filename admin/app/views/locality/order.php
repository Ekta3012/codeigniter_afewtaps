                             ...
                             <?php 
								...
								?>
								 ...
								 <div class="row text-center">
                                             ...
                                             <a href="<?php echo base_url(); ?>index.php/locality/lists/<?php echo $this->uri->segment(3); ?>"><button class="btn btn-w-m <?php echo isset($lists) ? $lists : "nonactive" ; ?>" data-attr="list" type="button">List of Restaurant</button></a>
                                             ...
                                             <a href="<?php echo base_url(); ?>index.php/locality/summary/<?php echo $this->uri->segment(3); ?>"><button class="btn btn-w-m <?php echo isset($summary) ? $summary : "nonactive" ; ?>" data-attr="summary" type="button">Summary</button></a>
                                              ...
                                              <a href="<?php echo base_url(); ?>index.php/locality/orderdta/<?php echo $this->uri->segment(3); ?>"><button class="btn btn-w-m <?php echo isset($order) ? $order : "nonactive" ; ?>" data-attr="orderdta" type="button">Order History</button></a>
...
<div class="col-md-5"></div>
											 ...
											 if (count ($getorder['ordrestab']) > 0)
									  {
										...
										?>
                                          ...
                                          <option <?php echo (set_value('estab') == $ordatadetails->{'estabid'}) ? "selected='selected'" : "" ; ?> value="<?php echo $ordatadetails->{'estabid'}; ?>"><?php echo $ordatadetails->{'estabname'}; ?></option>  
							            ...
							            foreach ($orderdata as $getdata)
											   {
												   ...
												   switch($getdata->{'status'})
													...
													echo '<tr class="">
															...
															<td>'.getOrderLocation($getdata->{'location'}).'</td>
															<td>'.$status.'</td>
															<td>'.$paymnt_method.'</td>
															<td>Rs. '.$getdata->{'total_amount'}.'/-</td>
														  </tr>';
												} 
										}
									else

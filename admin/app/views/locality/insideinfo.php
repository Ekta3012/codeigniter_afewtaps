                                    ...
                                    <?php   
                                       if (count($result['order']) > 0)
									   {
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
											  <ul>
											  <li>  <div class="col-md-6">Average Order Completion Time</div><div class="col-md-6">
												 <?php 
												        $kkk = 0;
														$cmp = 0;
														$avgtm = "00:00:00";
														if (is_array($result['order']) && count($result['order']) > 0)
															{
																foreach ($result['order'] as $data)
																   {
																	 if( ! empty($data->{'completion_time'}))
																		 {
																			 $kkk++;
																			 $diff = $data->{'completion_time'} - $data->{'order_time'};
																			 $cmp  = $cmp + $diff;
																		 }
																   }
																  if (! empty($cmp))
																  $avgtm =  gmdate('H:i:s', $cmp / $kkk);
															}
															      echo $avgtm;
													   ?>
													   </div>

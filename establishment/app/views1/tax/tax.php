                        ...
                        <div class="ibox-content">
							...
							<?php echo form_open('', array('class' => 'form-horizontal')); ?>
							    ...
							    <div class="row">
									...
									<div class="col-sm-3"><input type="text" placeholder="Tax rate" name="tax_rate" class="form-control" value="<?php echo isset($info->{'tax_rate'}) ? $info->{'tax_rate'} : set_value('tax_rate'); ?>" autocomplete="off" /></div>

							...
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
								  ...
								  <div class="row text-center">
									  <button class="btn btn-w-m active" data-attr="1" type="button">Food</button>
									  <button class="btn btn-w-m nonactive" data-attr="2" type="button">Beverages</button>
									  <button class="btn btn-w-m nonactive" data-attr="3" type="button">Dessert</button>
								  </div>
								  ...
								  <div class="row">
								      <div class="col-md-12 col-md-offset-2">
								        <div class="slides">
											<ul>
												<li class="liactive">Pizza Slices</span></li>
												<li>Full Pizza Pie</li>
												<li>Pastas</li>
												<li>Garlic Bread</li>
												<li>Pizza Slices</li>
												<li>Full Pizza Pie</li>
								  ...
								  <div class="row">
								      <div class="col-md-1"><i class="vg">&nbsp;</i></div>
								      <div class="col-md-7" style="font-size:15px;color:#293F54">Margherita</div>
								      <div class="col-md-2">Rs. 85 /-</div>
									  <div class="col-md-2"><a href="'.base_url().'index.php/cuisine/index/'.$cdata->{'id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/cuisine/del/'.$cdata->{'id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></div>
                                  </div>
								  
								  <div class="hr-line-dashed"></div>
								  
								  <div class="row">
								      <div class="col-md-1"><i class="nonvg">&nbsp;</i></div>
								      <div class="col-md-7" style="font-size:15px;color:#293F54">Onion Capsicum<br /><span style="font-size:11px">customization available</span></div>
								      <div class="col-md-2">Rs. 85 /-</div>
									  <div class="col-md-2"><a href="'.base_url().'index.php/cuisine/index/'.$cdata->{'id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/cuisine/del/'.$cdata->{'id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></div>
                                  </div>
								  ...
								  <div class="row">
								      <div class="col-md-1"><i class="vg">&nbsp;</i></div>
								      <div class="col-md-7" style="font-size:15px;color:#293F54">Margherita<br /><span style="font-size:11px">customization available</span></div>
								      <div class="col-md-2">Rs. 85 /-</div>
									  <div class="col-md-2"><a href="'.base_url().'index.php/cuisine/index/'.$cdata->{'id'}.'"><button class="btn btn-primary"><i class="fa fa-edit"></i> </button></a>&nbsp;&nbsp;<a href="'.base_url().'index.php/cuisine/del/'.$cdata->{'id'}.'" onclick="return confirm(\'Are you sure ?\')"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a></div>
                                  </div>

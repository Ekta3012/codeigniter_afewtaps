                 ...
                 <!-- Table -->
				        <div class="col-lg-12">
							<div class="ibox float-e-margins">
								...
								<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Miscellaneous</div>
								
								<div class="ibox-content">	
								   <ul>
								     <li><a href="mailto:info@afewtaps.com" title="Feedback" style="text-decoration:underline">- Feedback (info@afewtaps.com)</a></li>
								     <li><a href="<?php echo base_url(); ?>index.php/admin/faq" title="FAQ" style="text-decoration:underline">- FAQ</a></li>
									 
								     <li><a href="<?php echo base_url(); ?>index.php/admin/terms" title="Terms & Conditions" style="text-decoration:underline">- Terms & Conditions</a></li>
									 
								     <li><a href="<?php echo base_url(); ?>index.php/admin/policy" title="Privacy Policy" style="text-decoration:underline">- Privacy Policy</a></li>
								   </ul>

...
.active{background-color:#E2E2E2;color:#404040;box-shadow:none !important;border:1px solid #ccc}
</style>
</head>
<body>
                 ...
                 <!-- Table -->
				        <div class="col-lg-12">
							<div class="ibox float-e-margins">
								...
								<div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">FAQ</div>
								     ...
								     if (is_array($faq) && count($faq) > 0)
										 {
											 ...
											 echo '<div class="col-md-10">
									                  <p style="background-color: rgb(238, 238, 238);font-size: 14px;font-weight: bold;padding: 9px 11px;">Q1. '.$fdata->que.'</p>
	                                                  <p style="text-align:justify;">'.$fdata->ans.'</p> 
									                </div>';
										 }
									?>

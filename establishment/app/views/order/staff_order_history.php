                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-title">
                                    ...
                                    <?php $return_url = ($result['return_url']) ? $result['return_url'] : "";
                                ...
                                <a href="#">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pull-left wdth100 pdbtm">
                                            <div class="pull-left text-left lnehght24"><?php echo $result['otime']; ?> <br /><i class="fa fa-map-marker"></i> <?php echo getOrderLocation($result['location']); ?><br /><i class="fa fa-user"></i> <?php echo ucwords($result['staff_name']); ?></div>

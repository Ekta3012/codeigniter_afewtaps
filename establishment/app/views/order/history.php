                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-title">
                                    ...
                                    <?php
                                    $return_url = ($result['return_url']) ? $result['return_url'] : "";
                                    echo form_open('order/' . $return_url);
                                    ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2 input-group date" style="float:left;margin-right:3px">
                                                ...
                                                <select class="form-control fnt12" name="payment_method">
                                                    <option value="" <?php echo ($result['payment_method'] == "") ? "selected='selected'" : ""; ?> >All</option>
                                                    <option value="1" <?php echo ($result['payment_method'] == 1) ? "selected='selected'" : ""; ?> >Credit Purchase</option>
                                                    <option value="2" <?php echo ($result['payment_method'] == 2) ? "selected='selected'" : ""; ?> >Cash on delivery</option>
                                                    <option value="3" <?php echo ($result['payment_method'] == 3) ? "selected='selected'" : ""; ?>>Instamojo</option>
                                                </select>
                                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                if (count($result['cancel_list']['result']) > 0) {
                                                    ...
                                                    foreach ($result['cancel_list']['result'] as $data) {
                                                        ...
                                                        <tr class="">
                                                            <td><?php echo $i; ?> </td>
                                                            <td><a onclick="showPopUp(<?php echo $data->order_id; ?>)" href="javascript:void(0)"><?php echo $data->order_id; ?></a></td>
                                                            <td><?php echo date('h:i a,M d Y', $data->order_time); ?></td>
                                                            <td class="center"><?php echo getOrderLocation($data->location); ?></td>
                                                            <td class="center"<?php echo $style; ?> ><?php echo $order_status; ?></td>
                                                            <td class="center"><?php echo $payment; ?></td>
                                                            <td class="center"><?php echo $data->total_amount . ' /-'; ?></td>
                                                            <?php
                                                            if ($data->added_by == '1') {
                                                                ?>
                                                                <td class="center"><?php echo "Customer<br>" . ucwords($data->sname); ?> </td>
                                                                <?php
                                                            } else if ($data->added_by == '2') {
                                                                ?>
                                                                <td class="center"><?php echo "Staff<br>" . ucwords($data->staff_name); ?></td><?php } ?>
                                ...
                                <a href="#">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pull-left wdth100 pdbtm">
                                            <div class="pull-left text-left lnehght24"><?php echo $result['otime']; ?> <br /><i class="fa fa-map-marker"></i> <?php echo getOrderLocation($result['location']); ?><br /><i class="fa fa-user"></i> <?php
                                        if ($result['added_by'] == '1') {
                            ?>
                                                    <td class="center"><?php echo ucwords($data->sname); ?> </td>
                                                    <?php
                                                } else if ($result['added_by'] == '2') {
                                                    ?>
                                                    <td class="center"><?php echo ucwords($data->staff_name); ?></td><?php } ?>
                                            </div>

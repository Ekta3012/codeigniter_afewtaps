                                ...
                                <div class="ibox-content" style="min-height: auto;">
                                    ...
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs order_nav">
                                            <li <?php echo $all; ?>  style="padding:0 25px"><a id="stf_allTab" href="#tab-5" data-toggle="tab" aria-expanded="false">All</a></li>

                                            <li class="" style="padding:0 25px"><a href="#tab-6" id="stf_newTab" data-toggle="tab" aria-expanded="true">New</a><span class="" id="newBadge"></span></li>

                                            <li class="" style="padding:0 25px"><a href="#tab-7" id="stf_pendingTab" data-toggle="tab" aria-expanded="true">Pending</a><span class="" id="pendingBadge"></span></li>

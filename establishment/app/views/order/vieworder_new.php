    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content">
                ...
                if ($cancelled=='2') {
                    $all = 'class=""';
                    $stf_cancelled = 'class="active"';
                    $stf_cactive = 'active';
                    $custt_aactive = 'active';
                } else if(($cancelled=='1')){
                    $all = 'class=""';
                    $custt_cancelled = 'class="active"';
                    $custt_cactive = 'active';
                    $stf_aactive = 'active';
                }else{
                    $all = 'class="active"';
                    $custt_aactive = 'active';
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Staff Order Information</div>

                                <div class="ibox-content" style="min-height:auto;">

                                    <!-- Tab -->

                                    <div class="tabs-container staff">
                                        <ul class="nav nav-tabs order_nav">
                                            <li <?php echo $all; ?>  style="padding:0 25px"><a id="stf_allTab" href="#tab-1" data-toggle="tab" aria-expanded="false">All</a></li>

                                            <li class="" style="padding:0 25px"><a href="#tab-2" id="stf_newTab" data-toggle="tab" aria-expanded="true">New</a><span class="" id="newBadge"></span></li>

                                            <li class="" style="padding:0 25px"><a href="#tab-3" id="stf_pendingTab" data-toggle="tab" aria-expanded="true">Pending</a><span class="" id="pendingBadge"></span></li>

                                            <li <?php echo ($stf_cancelled)?$stf_cancelled:""; ?> style="padding:0 25px"><a href="<?php echo base_url(); ?>index.php/order/view?cancelled=2" >Cancelled</a></li>

                                        </ul>

                                        <div class="tab-content">
                                            <div class="tab-pane <?php echo ($stf_aactive)?$stf_aactive:""; ?>" id="tab-1">
                                                <div class="panel-body" id="allOrders_staff">
                                                    <!--  Container -->
                                                    just a moment...
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="tab-2">
                                                <div class="panel-body" id="preparation_staff">
                                                    just a moment...
                                                </div>
                                            </div>

                                            <div class="tab-pane" id="tab-3">
                                                <div class="panel-body" id="priority_staff">
                                                    just a moment...
                                                </div>
                                            </div>

                                            <div class="tab-pane <?php echo ($stf_cactive)?$stf_cactive:""; ?>" id="tab-4">
                                                <div class="panel-body" id="stf_cancelled">
                                                    <!-- Table -->

                                                    <div class="" style="margin:20px 0">

<?php echo form_open('order/view?cancelled=2'); ?>
...
if (count($stf_cancelled_orders['res']) > 0) {
    $i = 0;
    
    foreach ($stf_cancelled_orders['res'] as $data) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Customer Order Information</div>
                                ...
                                <div class="ibox-content" style="min-height:auto;">
                                    ...
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs order_nav">
                                            <li <?php echo $all; ?>  style="padding:0 25px">
                                                <a id="custt_allTab" href="#tab-5" data-toggle="tab" aria-expanded="false">All</a>
                                            </li>

                                            <li class="" style="padding:0 25px">
                                                <a href="#tab-6" id="custt_newTab" data-toggle="tab" aria-expanded="true">New</a><span class="" id="newBadge_custt"></span></li>

                                            <li class="" style="padding:0 25px"><a href="#tab-7" id="custt_pendingTab" data-toggle="tab" aria-expanded="true">Pending</a><span class="" id="pendingBadge_custt"></span></li>

                                            <li <?php echo ($custt_cancelled)?$custt_cancelled:""; ?> style="padding:0 25px"><a href="<?php echo base_url(); ?>index.php/order/view?cancelled=1" >Cancelled</a></li>

                                        </ul>

                                        <div class="tab-content">
                                            <div class="tab-pane <?php echo ($custt_aactive)?$custt_aactive:""; ?> " id="tab-5">
                                                <div class="panel-body" id="allOrders_custt">
                                                    <!--  Container -->
                                                    just a moment...
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="tab-6">
                                                <div class="panel-body" id="preparation_custt">
                                                    just a moment...
                                                </div>
                                            </div>

                                            <div class="tab-pane" id="tab-7">
                                                <div class="panel-body" id="priority_custt">
                                                    just a moment...
                                                </div>
                                            </div>

                                            <div class="tab-pane <?php echo ($custt_cactive)?$custt_cactive:""; ?>" id="tab-8">
                                                <div class="panel-body" id="custt_cancelled">
                                                    <!-- Table -->
...
<?php
if (count($custt_cancelled_orders['res']) > 0) {
    $i = 0;

    foreach ($custt_cancelled_orders['res'] as $data) {
        if ($data->user_flag == 1) {
            $customer_id = $this->db->select('customer_id')->get_where($this->db->dbprefix('order'))->row()->customer_id;
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin: 50px 0;">
                            <div class="custt clearfix" style="background: #ffffff;">
                                <div class="">
...
<?php } ?>
                ...
                setInterval(function () {
                    checkActiveTab_staff()
                }, 3000);
                setInterval(function () {
                    checkActiveTab_custt()
                }, 3000);
            ...
            $('#stf_allTab').on('click', function () {
                loadAllOrders_staff();
            });


            $('#stf_newTab').on('click', function () {
                loadNewOrders_staff();
            });

            $('#stf_pendingTab').on('click', function () {
                loadPendingOrders_staff();
            });


            $('#custt_allTab').on('click', function () {
                loadAllOrders_custt();
            });


            $('#custt_newTab').on('click', function () {
                loadNewOrders_custt();
            });

            $('#custt_pendingTab').on('click', function () {
                loadPendingOrders_custt();
            });


            function checkActiveTab_staff()
            {
                var activeTab = $('div.tabs-container.staff ul li.active a').html();
                switch (activeTab) {
                    case 'All':
                        loadAllOrders_staff();
                        break;
            ...
            function checkActiveTab_custt()
            {
                var activeTab = $('div.tabs-container.custt ul li.active a').html();
                switch (activeTab) {
                    case 'All':
                        loadAllOrders_custt();
                        break;
            ...
            function loadAllOrders_staff()
            {
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/order/homePageAllOrder_staff/<?php echo $estabid; ?>",
                                type: "GET",
                                dataType: "json",
                                async: false,
                                success: function (P)
                                 ...
                                 //   alert(P);
                                    ...
                                    if (typeof (data) != "undefined" && data != "")
                                    {
                                        ...
                                        $.each(data, function (E, F)
                                        {
                                            ...
                                            if (F.snm !== '')
                                                var sname = '<br /><i class="fa fa-user"></i> ' + F.snm + '';
                                            else
                                        ...
                                        $("#allOrders_staff").html(H);
                                    } else
                                    {
                                        $("#allOrders_staff").html("Sorry! No Order Found.");
                                    }
                                    staffPerformance(P.staff);
                                }
                            });
                        }
                        function loadAllOrders_custt()
                        {
                            $.ajax({
                                url: "<?php echo base_url(); ?>index.php/order/homePageAllOrder_custt/<?php echo $estabid; ?>",
                                            type: "GET",
                                            dataType: "json",
                                            async: false,
                                            success: function (P)
                                            {
                                                ...
                                                if (typeof (data) != "undefined" && data != "")
                                                {
                                                    ...
                                                    $("#allOrders_custt").html(H);
                                                } else
                                                {
                                                    $("#allOrders_custt").html("Sorry! No Order Found.");
                                                }
                                                staffPerformance(P.staff);
                                            }
                                        });
                                    ...
                                    function loadNewOrders_staff() {
                                        $.ajax({
                                            url: "<?php echo base_url(); ?>index.php/order/homePageNewOrder_staff/<?php echo $estabid; ?>",
                                                        type: "GET",
                                                        dataType: "json",
                                                        async: false,
                                                        success: function (P)
                                                        {
                                                            ...
                                                            if (typeof (data) != "undefined" && data != "")
                                                            {
                                                                ...
                                                                $("#preparation_staff").html(H);
                                                            } else
                                                            {
                                                                $("#preparation_staff").html("Sorry! No Order Found.");
                                                            }
                                                            staffPerformance(P.staff);
                                                        }
                                                    });
                                                ...
                                                function loadNewOrders_custt() {
                                                    $.ajax({
                                                        url: "<?php echo base_url(); ?>index.php/order/homePageNewOrder_custt/<?php echo $estabid; ?>",
                                                                    type: "GET",
                                                                    dataType: "json",
                                                                    async: false,
                                                                    success: function (P)
                                                                    {
                                                                        ...
                                                                        if (typeof (data) != "undefined" && data != "")
                                                                        {
                                                                            ...
                                                                            $("#preparation_custt").html(H);
                                                                            
                                                                        } else
                                                                        {
                                                                        
                                                                            $("#preparation_custt").html("Sorry! No Order Found.");
                                                                        }
                                                                        staffPerformance(P.staff);
                                                                    }
                                                                });
                                                            ...
                                                            function loadPendingOrders_staff() {

                                                                $.ajax({
                                                                    url: "<?php echo base_url(); ?>index.php/order/homePagePendingOrder_staff/<?php echo $estabid; ?>",
                                                                                type: "GET",
                                                                                dataType: "json",
                                                                                async: false,
                                                                                success: function (P)
                                                                                {
                                                                                    ...
                                                                                    if (typeof (data) != "undefined" && data != "")
                                                                                    {
                                                                                        ...
                                                                                        $("#priority_staff").html(H);
                                                                                    } else
                                                                                    {
                                                                                        $("#priority_staff").html("Sorry! No Order Found.");
                                                                                    }
                                                                                    staffPerformance(P.staff);
                                                                                }
                                                                            });
                                                                        ...
                                                                        function loadPendingOrders_custt() {

                                                                            $.ajax({
                                                                                url: "<?php echo base_url(); ?>index.php/order/homePagePendingOrder_custt/<?php echo $estabid; ?>",
                                                                                            type: "GET",
                                                                                            dataType: "json",
                                                                                            async: false,
                                                                                            success: function (P)
                                                                                            {
                                                                                                ...
                                                                                                if (typeof (data) != "undefined" && data != "")
                                                                                                {
                                                                                                    ...
                                                                                                    $("#priority_custt").html(H);
                                                                                                } else
                                                                                                {
                                                                                                
                                                                                                    $("#priority_custt").html("Sorry! No Order Found.");
                                                                                                }
                                                                                                staffPerformance(P.staff);
                                                                                            }
                                                                                        });

								...
								<div class="ibox-content">
									...
									<div class="tabs-container">
										<ul class="nav nav-tabs order_nav">
											...
											<li <?php echo $cancelled; ?> style="padding:0 25px"><a href="#tab-4" data-toggle="tab" aria-expanded="true">Cancelled</a></li>

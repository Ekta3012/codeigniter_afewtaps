                    ...
                    <div class="ibox float-e-margins">
					  <div class="bar brdrad5" style="border-bottom-left-radius:0;border-bottom-right-radius:0;">Add Menu Items</div>
                        ...
                        <div class="ibox-content">
							...
							<?php echo $this->session->flashdata('error') != '' ? '<div style=\'line-height:28px;margin:5px 0 20px 0\' class=\'btn-danger btn-xs\'><i class="fa fa-close"></i> '.strip_tags($this->session->flashdata('error')).'</div>' : ''; ?>
							...
							<?php echo form_open('menu/index', array('class' => 'form-horizontal')); ?>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Category&nbsp;</label>
									 <div class="col-sm-10">
										<div class="radio radio-success radio-inline">
												<input type="radio" checked="checked" name="cat" value="1" id="foodCat" />
												<label for="foodCat">Food</label>
										</div>
										
										<div class="radio radio-success radio-inline">
												<input type="radio" value="2" id="drinksCat" name="cat" <?php echo isset($info->{'type'}) ? ($info->{'type'} == 2 ? "checked='checked'" : "") : ""; ?> />
												<label for="drinksCat">Drinks</label>
										</div>
								...
								<div class="form-group">
                                    <div class="col-sm-12 text-center">
									   ...
									   <select tabindex="-1" style="width:350px;display:none;" class="categoryData form-control" data-placeholder="Enter New Category Or Choose a Category..." name="category">
									  ...
									  <div class="col-sm-2" style="display:none" id="drinksContainer">
										 <div class="row">
												...
												<div class="radio radio-danger radio-inline col-sm-12">
													<input type="radio" checked="checked" name="drinks_cat" value="3" id="radio6">
													<label for="radio6">Alcoholic</label>
												</div>
											
												<div class="radio radio-danger radio-inline col-sm-12" style="margin:0">
														<input type="radio" value="4" id="radio7" name="drinks_cat">
														<label for="radio7">Non Alcoholic</label>
												</div>
												
												<div class="radio radio-danger radio-inline col-sm-12" style="margin:0">
														<input type="radio" value="5" id="radio8" name="drinks_cat">
							...
							<div class="row" id="uploadExcel">
							    <div class="col-sm-10 text-center" style="font-size:20px">
								    <strong>OR</strong>
							    </div>
							 ...
							 <?php echo form_open_multipart('menu/uploadExcel'); ?>
							 
							      <?php echo $this->session->flashdata('error') != '' ? '<div style=\'line-height:28px;margin:5px 0 20px 0\' class=\'btn-danger btn-xs\'><i class="fa fa-close"></i> '.strip_tags($this->session->flashdata('error')).'</div>' : ''; ?>
							
							      <?php echo $this->session->flashdata('menu_add1') != '' ? '<div style=\'line-height:28px;margin:5px 0 20px 0\' class=\'btn-primary btn-xs msgsuc\'><i class="fa fa-check"></i> Menu item added successfully.</div>' : ''; ?>
							 
							 
							     <div class="form-group"><label class="col-sm-2 control-label">Excel File&nbsp;</label>
									 <div class="col-sm-10">
										<input type="file" name="userfile" accept=".xls" />
										<i> (upload only <b>.xls</b> file) </i>
									 </div>
								 </div>

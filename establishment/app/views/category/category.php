...
<title><?php echo config_item('admin_page_title'); ?>Category</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
							...
							<?php
							    echo ($this->session->flashdata('parent') != '') ? '<div style=\'line-height:28px;margin:5px 0 20px 0\' class=\'btn-danger btn-xs\'><i class="fa fa-remove"></i> Please Select Parent Category.</div>' : '';
							 ?>
							...
							<?php echo form_open('', array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Category Name</label>
                                    <div class="col-sm-10"><input type="text" name="category_name" value="<?php echo isset($info->{'category_name'}) ? $info->{'category_name'} : set_value('category_name'); ?>" class="form-control" placeholder="Category Name" autocomplete="off" /></div>
                                </div>
